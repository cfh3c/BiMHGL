...
function [IniY IniYT H HT nTest gt mPara] = BiHGConstruction_fb(mPara,mTrainTestSplitBig)
...
IniYT = [];
for iM=1:nExpFea
    nEdge = nEdge+ mDimModel(mExpFea(iM,1),1);
    IniYT = [IniYT ; mPara.mWordSentiment{mExpFea(iM,1),1}];
end
